...
export default function LoginPage() {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen relative bg-gradient-to-br from-blue-900 via-black to-blue-800 overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-xl p-12 bg-white/5 backdrop-blur-4xl rounded-4xl shadow-[0_0_60px_rgba(0,0,255,0.5)] border border-blue-500/20 space-y-8 mb-10">
                <h1 className="text-4xl mb-10 md:text-5xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 animate-text">
                    Sign In to <span className="text-white">QueryAI</span>
                </h1>
